...
$lang['teletest_logo'] = '<span class=\'logo\'>Teletest</span>';
$lang['teletest_version'] = 'Version';

$lang['clients_add_contact'] = 'Add Contact';
$lang['clients_address1'] = 'Address1';
$lang['clients_address2'] = 'Address2';
$lang['clients_assigned_to_them'] = 'information assigned to them. You are about to <strong class="error">permanently delete</strong> this client, and <strong class="error">every information associated with them</strong>. Are you sure you want to do this?';
...
$lang['clients_delete_all_invoices'] = 'Delete client and all the related information';
...
$lang['error_email_recipients'] = 'Please select at least 1 recipient';
...
$lang['error_problem_editing'] = 'There was a problem editing';
$lang['error_problem_inserting'] = 'Problem inserting';
$lang['error_problem_saving'] = 'There was a problem saving for sending.';
$lang['error_selection'] = 'The selection you made had no data';

$lang['install_explain'] = 'Your email is used both as your &quot;username&quot; for logging in, and also for any email tasks, such as sending invoices, resetting passwords, etc.  The Primary Contact name is used in the &quot;from&quot; field when sending out email.';
$lang['install_install'] = 'Install';
$lang['install_welcome'] = 'Welcome to '.$lang['teletest_logo'].'.  In order to install I just need to gather a few things about you.';
...
$lang['login_logout_success1'] = "You've been successfully logged out.";
...
$lang['login_password_reset_demo'] = 'This is disabled, but you would have received an email with reset information.';
$lang['login_password_reset_disabled'] = 'Password resetting is disabled.';
$lang['login_password_reset_email1'] = 'Someone (presumably you), has requested a password reset for your account.';
...
$lang['login_password_reset_title'] = 'Teletest Password Reset';
...
$lang['settings_will_use'] = 'will use when you generate add sites or contacts';
...
$lang['utilities_phpinfo_not_available'] = 'This feature is not available';
$lang['utilities_new_version_available'] = "A new version of Teletest version is now available. "; // space after period
$lang['utilities_up_to_date'] = "You are using the most recent version of Teletest.";
$lang['utilities_connection_failed'] = "A connection to http://irfantoor.com/t2 could not be established.";
