...
function LyteBox() {
	...
	/*** Configure Slideshow Options ***/
		...
		this.showPrint			= true;		// true to display the Print button, false to hide
...
LyteBox.prototype.initialize = function() {
	...
	var objNavDisplay = this.doc.createElement("span");
   	...
   	var objPrint = this.doc.createElement("a");
		objPrint.setAttribute('id','lbPrint');
		objPrint.setAttribute((this.ie ? 'className' : 'class'), this.theme);
		objPrint.setAttribute('href','#');
		objBottomNav.appendChild(objPrint);
...
LyteBox.prototype.start = function(imageLink, doSlide, doFrame) {
	...
	this.doc.getElementById('lbPrint').onclick = function() { myLytebox.print(); return false; }
...
LyteBox.prototype.showContent = function() {
	if (this.wDone && this.hDone) {
		...
		if (this.isSlideshow) {
			...
			this.doc.getElementById('lbPrint').style.display = '';
...
LyteBox.prototype.print = function() {
	
	frames['lbIframe'].focus();
	frames['lbIframe'].print();
};
