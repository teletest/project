	       ...
	       $this->load->library('upload', $config);
			...
			{ 
				...
				{   	
					...
					'latitude' =>$data[3],
					'longitude' =>$data[4],
					'candidate_distance' =>$data[5],
					'proposed_antenna_height' =>$data[6],
					'antenna_height'=>$data[7],
					'site_type' =>$data[8],
					'clutter_type' =>$data[9],
					'building_height' =>$data[10],
					'parapet_height' =>$data[11],
					'rbs_type' => $data[12],
					'structure_type' => $data[13],
					'structure_height' => $data[14],
					'azimuths' => $data[15],
					'tilt' => $data[16],
					'feeder_type' => $data[17],
					'feeder_length' => $data[18],
					'site_address' => $data[19],
					'coverage_area_prediction' => $data[20],
					'coverage_area1' => $data[21],
					'coverage_area2' => $data[22],
					'coverage_area3' => $data[23],
					'ranking' => $data[24],
					'remarks' => $data[25],
					'engineer' => $data[26],
					'status' => $data[27],
