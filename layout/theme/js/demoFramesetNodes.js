...
foldersTree = gFld("<i>Treeview Demo</i>", "demoFramesetRightFrame.html")
  ...
  aux1 = insFld(foldersTree, gFld("New Project", "demoFramesetRightFrame.html"))
 ...
 //     insDoc(aux2, gLnk("R", "Athens", "http://www.treeview.net/treemenu/demopics/beenthere_athens.jpg"))
  ...
  aux1 = insFld(foldersTree, gFld("Site Plane", "javascript:parent.op()"))
aux1.iconSrc = ICONPATH + "complexType.gif"
  aux1.iconSrcClosed = ICONPATH + "complexType.gif"

    aux2 = insFld(aux1, gFld("Nominal Plan", "http://www.treeview.net/treemenu/demopics/beenthere_unitedstates.gif"))
