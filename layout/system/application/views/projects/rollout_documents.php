...
<table width="90%" border="0" cellpadding="0" cellspacing="1" class="ewTable">
			  ...
			  <tbody id="thetable">
				  ...
				  <tr onmouseover="ew_MouseOver(this);" onmouseout="ew_MouseOut(this);">
                    ...
                    <td align="center"><a href='download_file/{site_id}_{filename}' ><img src="{site_url}/theme/images/download_icon.jpg" height="24" width="24"></a></td>
					<?php if($this->session->userdata('is_admin')) { ?>
				    <td align="center"><a href='attachment_delete/{id}/{site_id}'  class="confirmClick" title="Delete this file"><img src="{site_url}/theme/images/delete.png" height="24" width="24"></a></td>
				    <?php } else { ?> <td>&nbsp;</td> <?php } ?>
				  </tr>
				  {/rolled_out_doc}
			  </tbody>
