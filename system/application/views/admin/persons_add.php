...
<form name="form1" id="form1"  method="post" action="add">
      <table class="std" border="0" cellpadding="0" cellspacing="1" width="100%">
        ...
        <tbody>
		  ...
		  <tr>
            ...
            <td><span style="color:red;"><?php echo form_error('login'); ?><input class="text" name="login" id="login" value="<?php  echo set_value('login'); ?>" disabled></td>
          </tr>
          
		  <tr>
            <td align="right">* Password:</td>
            <td><span style="color:red;"><?php echo form_error('password'); ?></span><input class="text" name="password" id="password" value="<?php  echo set_value('password'); ?>" maxlength="32" size="32" type="password" disabled> </td>
            <td align="right">* Confirm Password:</td>
            <td><span style="color:red;"><?php echo form_error('password_check'); ?></span><input class="text" name="password_check" id="password_check" value="<?php  echo set_value('password_check'); ?>" maxlength="32" size="32" type="password" disabled></td>
          </tr>
