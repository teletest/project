...
<!--Tab Start-->
        <script src="{site_url}js/jquery-1.1.3.1.pack.js" type="text/javascript"></script>
        <script src="{site_url}js/jquery.history_remote.pack.js" type="text/javascript"></script>
        <script src="{site_url}js/jquery.tabs.pack.js" type="text/javascript"></script>
        <script type="text/javascript">
            $(function() {
                $('#ShowTab').tabs({ fxSlide: false });
            });
        </script>

        <link rel="stylesheet" href="{site_url}css/jquery.tabs.css" type="text/css" media="print, projection, screen">
...
<SCRIPT src="{site_url}js/demoFramesetNodes.js"></SCRIPT>
<script type="text/javascript"> 
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td background="{site_url}images/top-liner.gif"></td>
    <td width="8" height="8"><img src="{site_url}images/corner-top-right.gif" width="8" height="8" alt=""></td>
  </tr>
  <tr>
    <td background="{site_url}images/liner-left.gif"></td>
    <td height="300" align="center" valign="top" bgcolor="#E8E8E8"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="14%" align="left" bgcolor="#FFFFFF"><img src="{site_url}images/header-logo.jpg" width="161" height="144" /></td>
            <td width="39%" align="left" bgcolor="#FFFFFF"><img src="{site_url}images/header-text.jpg"  /></td>
            <td width="47%" height="144" align="center" valign="bottom" background="{site_url}images/header-map.jpg" bgcolor="#FFFFFF" style="background-position:right;background-repeat:no-repeat;">
            <table border="0" width="94%" cellspacing="1">
									...
									<tr>
										...
										<td width="30">
								          ...
								          <img border="0" src="{site_url}images/home.png" width="25" height="25" id="img1" onmouseout="this.src='{site_url}images/home.png'" onmouseover="this.src='{site_url}images/homeover.png'"></a></td>

									  <td width="30">

										<a title="My Account" href="#">

									    <img border="0" src="{site_url}images/account.png" width="25" height="25" id="img2" onmouseout="this.src='{site_url}images/account.png'" onmouseover="this.src='{site_url}images/accountover.png'"></a></td>

									  <td width="30">

										<a title="Search" href="#"><img border="0" src="{site_url}images/search.png" width="25" height="25" id="img3" onmouseout="this.src='{site_url}images/search.png'" onmouseover="this.src='{site_url}images/searchover.png'" /></a></td>
                    ...
                    <td height="30" bgcolor="#d1d1d1"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td width="27%"><table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center" valign="middle"><img src="{site_url}images/minimize.png" width="24" id="imgTree" height="24" onclick="HideMe(mnuTree,imgTree);" style="cursor:pointer;" alt="Minimize Menu" /></td>
                            <td align="center" valign="middle"><img src="{site_url}images/close.png" width="24" height="24" style="cursor:pointer;" alt="Close Menu" /></td>
                          </tr>
                        </table></td>
                      </tr>
                    </table></td>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #d1d1d1;">
                  <tr>
                    <td height="30" bgcolor="#d1d1d1"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td width="27%"><table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center" valign="middle"><img src="{site_url}images/minimize.png" width="24" id="imglgn" height="24" onclick="HideMe(mnulgn,imglgn);" style="cursor:pointer;" alt="Minimize Menu" /></td>
                            <td align="center" valign="middle"><img src="{site_url}images/close.png" width="24" height="24" style="cursor:pointer;" alt="Close Menu" /></td>
                          </tr>
                        </table></td>
                      </tr>
                  ...
                  <tr>
                   ...
                   Password<br />
                      ...
                      <br />
                      <input type="image" src="{site_url}images/login.jpg"  />
             <br />
